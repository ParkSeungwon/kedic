...
public:
	...
	void quote(std::string open, std::string close); // set quote, tokenizing invalid inside quote
	void separate(std::string sep); // set separator
	void escape(char esc); // set escape character
	void clear();
